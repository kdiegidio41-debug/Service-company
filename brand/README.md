...
Not part of the website upload (the zip only includes the site files).

| File | Size | Use it for |
| --- | --- | --- |
| `everglow-logo-square.png` | 1080 × 1080 | Google Business Profile logo, Instagram and Facebook profile pictures |
| `everglow-cover.png` | 1800 × 1013 | Google Business Profile and Facebook cover images |
| `everglow-logo-wide-dark.png` | 1092 × 353 | Dark backgrounds: email signatures, dark flyers, truck magnets |
